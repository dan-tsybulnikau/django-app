...
SECRET_KEY = "django-insecure-58st24ov=znv+463+ua)4zfoir(g4&yded957w29g%od+59^tj"
...
INSTALLED_APPS = [
    ...
    "allauth.socialaccount.providers.github",  # для каждого провайдера
    "rest_framework",
    "django_filters",
    "debug_toolbar",
    "ckeditor",
